"""Prove v2 fixes presentation only, not the preserved handwriting miss."""
...
def test_preserved_v1_outputs_diagnose_as_presentation_fixed_but_handwriting_failed():
